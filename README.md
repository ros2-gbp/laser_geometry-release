## laser_geometry (rolling) - 3.0.1-1

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Tue, 26 May 2026 07:49:01 -0000`
...
## laser_geometry (rolling) - 3.0.0-1

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Wed, 06 May 2026 19:50:14 -0000`
...
- upstream repository: https://github.com/ros-perception/laser_geometry.git
- release repository: https://github.com/ros2-gbp/laser_geometry-release.git
- rosdistro version: `2.11.3-5`
- old version: `2.11.3-5`
- new version: `3.0.0-1`
...
## laser_geometry (rolling) - 2.11.3-4

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Tue, 24 Mar 2026 20:43:30 -0000`
...
- old version: `2.11.3-3`
- new version: `2.11.3-4`
...
## laser_geometry (rolling) - 2.11.3-3

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Tue, 24 Mar 2026 16:31:36 -0000`
...
- release repository: https://github.com/ros2-gbp/laser_geometry-release.git
- rosdistro version: `2.11.2-1`
- old version: `2.11.3-2`
- new version: `2.11.3-3`
...
## laser_geometry (rolling) - 2.11.3-2

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Tue, 24 Mar 2026 16:29:28 -0000`
...
## laser_geometry (rolling) - 2.11.3-1

The packages in the `laser_geometry` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling laser_geometry` on `Tue, 24 Mar 2026 16:26:13 -0000`
